            ...
            <div class="row">
                <article class="col-lg-6">
                    <figure class="tm-person">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/about-01.jpg" alt="Image" class="img-fluid tm-person-img" />
                ...
                <article class="col-lg-6">
                    <figure class="tm-person">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/about-02.jpg" alt="Image" class="img-fluid tm-person-img" />
                        <figcaption class="tm-person-description">
                ...
                <article class="col-lg-6">
                    <figure class="tm-person">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/about-03.jpg" alt="Image" class="img-fluid tm-person-img" />
                        <figcaption class="tm-person-description">
                ...
                <article class="col-lg-6">
                    <figure class="tm-person">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/about-04.jpg" alt="Image" class="img-fluid tm-person-img" />
                        <figcaption class="tm-person-description">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="placeholder-2">
                        <div class="parallax-window-2" data-parallax="scroll" data-image-src="<?php bloginfo('template_url') ?>/assets/img/about-05.jpg"></div>		
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="tm-history-inner">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/about-06.jpg" alt="Image" class="img-fluid tm-history-img" />
